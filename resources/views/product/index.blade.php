            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        <a href="{{ route('product.info') }}" class="btn btn-primary">Tambahkan</a>
                    </div>
                </div>
                <form action="{{ route('product.search') }}" method="post" style="display: none;" id="form_search">
                    @csrf
...
@push('scripts')
    <script>
        ...
        formSearch.submit(function (e) {
            ...
            button.html('Loading ...');
            $.post("{{ route('product.search') }}?page=" + selectedPage, {
                _token: '{{ csrf_token() }}',
